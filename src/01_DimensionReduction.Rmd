---
title: "Risk and Resilience: Socioeconomic Dimensions of Pandemic Health Outcomes"
subtitle: "01 – Dimension Reduction"
author: "Kolja Nenoff"
date: "2023-11-03"
output: html_document
---

This analysis builds on the code of **Kraemer et al. (2018)**.  
World Bank indicators were collected on **03.11.2023** from the [World Bank Data Catalog](https://datacatalog.worldbank.org/dataset/world-development-indicators).

---

# Setup  

We begin by loading libraries, setting default plotting themes, defining computational resources, and preparing file paths.
...
libraries <- c(
  "magrittr", "tidyverse", "data.table", "parallel",
  "dimRed", "devtools", "igraph", "energy",
  "ggrepel", "ggraph", "trend", 
  "RANN", "RJSONIO", "RSpectra", "ggokabeito"
)
# Install missing libraries and load them
...
```{r}
# Configure default color palettes and theme
options(
...
## Cluster recources
```{r}
# Setup for parallel processing (local with 50 threads)
...
LIB_DIR    <- "../libraries"
WDI_DIR   <- "231103_WDI" # Download at https://datacatalog.worldbank.org/dataset/world-development-indicators
EXMORT_DIR    <- "../data/input_data/230225_WHO_Excess_Mort/2022-03-25_covid-19_gem" #Supplement of https://www.nature.com/articles/s41586-022-05522-2#MOESM1
...
wdi_series_path   <- file.path(INPUT_DIR,WDI_DIR, "WDISeries.csv") #contains more information on the single indicators.
wdi_data_path     <- file.path(INPUT_DIR,WDI_DIR, "WDIData.csv") #contains the main data table.
wdi_country_path  <- file.path(INPUT_DIR,WDI_DIR, "WDICountry.csv") #contains more information on the countries and regions.

```
Download the WDI data at https://datacatalog.worldbank.org/dataset/world-development-indicators


```{r}
# Human Development Index
HDI_data_path     <- file.path(INPUT_DIR, "01_hdi_data.csv")
wdi_income_path   <- file.path(INPUT_DIR, "CLASS.xlsx")  # World Bank classification (2023-11-03)

# WHO Excess Mortality Data
...
toolbox_path               <- file.path(LIB_DIR, "00_toolbox.R")
wdi_dimred_path            <- file.path(LIB_DIR, "01_lib_WDI_dimred.R")  # Modified version of Kraemer et al. (2018)
```

## Load Custom Functions and recources
```{r}
# Source custom helper functions and scripts
...
COUNTRY_CODES<-ExcessMortbyContry$iso3 %>%  unique
```
...
fwrite(wdi_data_cons_pca_gap_filled, file.path(DATA_DIR,"01_wdi_gapfilled.csv"))
```
